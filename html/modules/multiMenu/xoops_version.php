...
$modversion['detailed_version'] = '2.30.1';
$modversion['description']      = _IM_MULTIMENU_DESC;
$modversion['author']           = "Tom Hayakawa. Nuno Luciano (aka gigamaster), 2020 XCL PHP7.";
$modversion['credits']          = "Original module by Solo, luinithil, Wolf. Contributors: Domifara, Naoki Sawada, Naoki Okino, Nobunobu, Yoshi Sakai, Toshihiro Takehara (aka nouphet).";
